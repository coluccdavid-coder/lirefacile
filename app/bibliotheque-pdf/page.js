...
// Synchronisation directe avec Exercices AVC
...
await generateSummary(file, updated);
  };

const generateSummary = async (file, updatedFiles) => {
    try {
