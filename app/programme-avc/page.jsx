...
export default function ProgrammeAVC() {
...
const avcExercises = savedExercises.filter((ex) => {
      const type = (ex.type || "").toLowerCase();
return (
        type.includes("langage") ||
        type.includes("memoire") ||
        type.includes("mémoire") ||
...
if (avcExercises.length > 0) {
      setExercises(avcExercises);
    }
setLoading(false);
  }, []);
const nextExercise = () => {
...
if (exercises.length === 0) {
    return (
      <div className="page-container">
        <div className="main-card">
          <h1 className="main-title">Programme AVC</h1>
...
<div className="assistant-message">
            Programme IA construit depuis les symptômes, PDF et mémoire.
          </div>
        </div>
